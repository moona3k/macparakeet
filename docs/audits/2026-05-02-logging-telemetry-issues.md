...
| LOGTEL-003 | P1 | FIXED | Add Worker/Swift event-name sync check | Guard recovered onto `feat/telemetry-agent-debug` as `scripts/ci/check-telemetry-allowlist.sh` and wired into CI. |
