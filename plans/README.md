...
|------|-------|--------|----------|-------------|
| [2026-07-20-dapt-export](active/2026-07-20-dapt-export.md) | DAPT original-transcript export (#850) | **REVIEW** | P1 | Implementation, external W3C/BBC validation, and the final full-suite gate are complete. Remaining: PR/hosted CI and fresh-eye review against the exact PR head. |
