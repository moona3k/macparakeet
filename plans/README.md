...
> **2026-07-22** against `main` after the stable v0.7.3 release and the
> post-release reliability wave through #860. Completed implementation records and obsolete
...
| [2026-06-14-meeting-mic-reliability](active/2026-06-14-meeting-mic-reliability.md) | Meeting capture reliability — mic-health watchdog | **PARTIAL** | P2 | Detection/telemetry shipped as #523; source-owned mic callback recovery, typed system recovery, actionable warnings, and frame-derived capture reports shipped in #857/#860. The remaining defined product slice is post-stop VAD transcript-gap repair; amplitude-inferred restart remains evidence-gated. ADR-025, REQ-MEET-017/018. |
...
## Recently archived → `completed/` (2026-07-22)

- **2026-07-20-dapt-export** → implemented in #854: deterministic DAPT 1.0
  export across app, auto-save, bulk export, and generic CLI surfaces, with the
  v1 boundary contract and external W3C/BBC validation.
- **2026-07-04-meeting-health-artifacts-speaker-rename** → implemented in
  #707/#708/#710; the later actionable-only recovery presentation in #857/#860
  now owns the product direction recorded by ADR-025.
