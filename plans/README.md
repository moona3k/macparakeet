...
| [2026-06-19-boundary-contracts](active/2026-06-19-boundary-contracts.md) | Boundary contract docs + contract tests | **EXECUTOR-READY** | P2 | Create `spec/contracts/` and the first three tested contracts: meeting artifacts, meeting recovery/retention safety, and CLI JSON/spec output. StenoAI-inspired contract habit, but native to MacParakeet: Markdown contracts linked to XCTest, not a new architecture layer. |
| [2026-06-19-meetings-workspace-productization](active/2026-06-19-meetings-workspace-productization.md) | Meetings workspace productization from StenoAI lessons | **PROPOSED** | P2 | Review-backed staged plan: make Meetings a compact daily workspace, expose artifact folders/paths, add DB-backed folders/projects, add local indexing before cross-meeting Ask, and create a full-app meeting smoke harness. |
