...
|------|-------|--------|----------|-------------|
| [2026-09-14-issue-609-calendar-event-skip](active/2026-09-14-issue-609-calendar-event-skip.md) | Per-event calendar skip (#609) | **PROPOSED** | P2 | Design accepted 2026-09-14 (ADR-017 §11 / F48), then corrected from two review rounds: recurrence flag, eventKey, CLI annotations-only, owning-countdown re-eval, immediate skip/unskip rearm. Not implemented. |
