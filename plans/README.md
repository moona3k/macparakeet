...
|------|-------|--------|----------|-------------|
| [2026-09-14-issue-609-calendar-event-skip](active/2026-09-14-issue-609-calendar-event-skip.md) | Per-event calendar skip (#609) | **IMPLEMENTED** | P2 | Built on `feat/issue-609-calendar-event-skip`: occurrence/event mute, Upcoming + toast, CLI annotations, owning-countdown re-eval. Merge review remains. |
