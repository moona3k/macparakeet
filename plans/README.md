...
|------|-------|--------|----------|-------------|
| [2026-09-13-timed-transcript-editing](active/2026-09-13-timed-transcript-editing.md) | Timed transcript text editing and line merge (#893) | **IN PROGRESS** | P1 | Implement ADR-030 through the existing correction journal: line text edits, adjacent same-speaker merge, one effective projection, aligned consumers, UX, contracts, and final verification. |
