...
|------|-------|--------|----------|-------------|
| [2026-09-05-post-meeting-notes-and-prompt-context](active/2026-09-05-post-meeting-notes-and-prompt-context.md) | Post-meeting notes, opt-in prompt context, and rich Markdown follow-up | **IMPLEMENTED / QA REMAINDER** | P2 | Saved notes and context are proposed upstream in #959; the separately extracted Markdown renderer is in #957. The dated 2026-09-05 QA failures are retained in the plan. Subsequent code fixes cover table selection/actions and streaming reappearance; manual VoiceOver, streaming/live Ask, keyboard-link, 360 px, and release-size checks remain separate acceptance gates. |
