...
|------|-------|--------|----------|-------------|
| [2026-09-14-issue-609-calendar-event-skip](active/2026-09-14-issue-609-calendar-event-skip.md) | Per-event calendar skip (#609) | **PROPOSED** | P2 | Design accepted 2026-09-14 (ADR-017 §11 / F48). Persist occurrence/series mute in UserDefaults; `MeetingMonitor.candidates` shared by Upcoming/CLI/coordinator; Upcoming context menu + toast ✕; no optional-invite auto-exclude. Not implemented. |
