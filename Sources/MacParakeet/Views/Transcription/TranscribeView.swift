...
struct TranscribeView: View {
    ...
    private struct InspirationQuote {
        ...
        static let rotation: [InspirationQuote] = [
            ...
            InspirationQuote(text: "The living is functionally one with the cosmic.", author: "Wilhelm Reich"),
            ...
            InspirationQuote(text: "Live ideas; do not just think them.", author: "Rudolf Steiner"),
            InspirationQuote(text: "In some sense man is a microcosm of the universe.", author: "David Bohm"),
            ...
            InspirationQuote(text: "You are an aperture through which the universe is looking at itself.", author: "Alan Watts"),
