...
struct RetranscribeCommand: AsyncParsableCommand, CLITelemetryMetadataProviding {
    ...
    @Option(name: .long, help: "Parakeet build: app-default, v3, v2, unified, orukeet, or redux (compact multilingual via Photon). Ignored for Nemotron, Cohere, and Whisper.")
