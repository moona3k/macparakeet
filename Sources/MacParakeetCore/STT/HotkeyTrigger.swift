...
public struct HotkeyTrigger: Sendable {
    ...
    public static let dictationAIPolishDefaultsKey = "dictationAIPolishHotkeyTrigger"
    public static let dictationClipboardDefaultsKey = "dictationClipboardHotkeyTrigger"
