...
final class DAPTExportTests: XCTestCase {
    ...
    func testAlignedSpeakerIDMissingFromPartialRosterUsesAnonymousIDAlias() throws {
        let transcription = Transcription(
            fileName: "partial-roster.wav",
            rawTranscript: "Named turn. Anonymous turn.",
            wordTimestamps: [
                WordTimestamp(word: "Named", startMs: 0, endMs: 300, confidence: 0.9, speakerId: "S1"),
                WordTimestamp(word: "turn.", startMs: 300, endMs: 700, confidence: 0.9, speakerId: "S1"),
                WordTimestamp(word: "Anonymous", startMs: 900, endMs: 1_200, confidence: 0.9, speakerId: "S2"),
                WordTimestamp(word: "turn.", startMs: 1_200, endMs: 1_600, confidence: 0.9, speakerId: "S2"),
            ],
