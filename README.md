...
| Development source (this revision) | Unreleased; not the stable download | Contains unreleased changes since 0.8.7. See [Sources/CLI/CHANGELOG.md](Sources/CLI/CHANGELOG.md) for CLI version history; check the source commit before attributing development behavior to the stable DMG. |
