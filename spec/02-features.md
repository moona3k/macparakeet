...
- [x] Optional default-off preserve of cancelled dictations (`preserveDiscardedDictations`) saves the transcript to History without pasting
...
| Preserve discarded dictations | Default-off Dictation setting (`preserveDiscardedDictations`). Cancel and undo-window expiry transcribe into History as `cancelled` instead of deleting. Nothing is pasted. Voice stats still count only completed takes. | [F1](02-features.md#f1-system-wide-dictation) |
