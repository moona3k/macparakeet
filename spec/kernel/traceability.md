...
| REQ-STT-004 | `MacParakeetCore/SpeechEnginePreference.swift`, `MacParakeetCore/STT/NemotronEnglishEngine.swift`, `MacParakeetCore/STT/STTRuntime.swift`, `MacParakeetCore/STT/STTScheduler.swift`, `MacParakeetViewModels/SettingsViewModel.swift`, `MacParakeet/Views/Settings/SettingsView.swift`, `CLI/Commands/ModelsCommand.swift`, `CLI/Commands/TranscribeCommand.swift`, `CLI/Commands/ConfigCommand.swift` | `SpeechEnginePreferenceTests.swift`, `ModelDeletionTests.swift`, `STTSchedulerTests.swift`, `SettingsViewModelTests.swift`, `ModelLifecycleCommandTests.swift`, `ConfigCommandTests.swift`, `TranscribeCommandTests.swift` |
